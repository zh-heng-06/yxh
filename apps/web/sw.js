const CACHE="zhanggui-v28";
self.addEventListener("install",event=>event.waitUntil(caches.open(CACHE).then(cache=>cache.addAll(["/","/styles.css?v=28","/app.js?v=28","/src/local-client.js?v=28","/icon.svg"])).then(()=>self.skipWaiting())));
