const CACHE="zhanggui-v25";
self.addEventListener("install",event=>event.waitUntil(caches.open(CACHE).then(cache=>cache.addAll(["/","/styles.css?v=25","/app.js?v=25","/src/local-client.js?v=25","/icon.svg"])).then(()=>self.skipWaiting())));
