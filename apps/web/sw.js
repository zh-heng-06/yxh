const CACHE="zhanggui-v24";
self.addEventListener("install",event=>event.waitUntil(caches.open(CACHE).then(cache=>cache.addAll(["/","/styles.css?v=24","/app.js?v=24","/src/local-client.js?v=24","/icon.svg"])).then(()=>self.skipWaiting())));
