const CACHE="zhanggui-v21";
self.addEventListener("install",event=>event.waitUntil(caches.open(CACHE).then(cache=>cache.addAll(["/","/styles.css?v=21","/app.js?v=21","/src/local-client.js?v=21","/icon.svg"])).then(()=>self.skipWaiting())));
