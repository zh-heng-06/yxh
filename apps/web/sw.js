const CACHE="zhanggui-v27";
self.addEventListener("install",event=>event.waitUntil(caches.open(CACHE).then(cache=>cache.addAll(["/","/styles.css?v=27","/app.js?v=27","/src/local-client.js?v=27","/icon.svg"])).then(()=>self.skipWaiting())));
