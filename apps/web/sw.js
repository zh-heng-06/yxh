const CACHE="zhanggui-v23";
self.addEventListener("install",event=>event.waitUntil(caches.open(CACHE).then(cache=>cache.addAll(["/","/styles.css?v=23","/app.js?v=23","/src/local-client.js?v=23","/icon.svg"])).then(()=>self.skipWaiting())));
